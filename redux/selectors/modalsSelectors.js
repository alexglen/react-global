...
export const currentCardIdSelector = createSelector(
  getModalState,
  (modals) => modals.currentCardId
);
...
export const deleteModalOpenSelector = createSelector(
  getModalState,
  (modals) => modals.isDeleteModalOpen
);
export const cardModalOpenSelector = createSelector(
  getModalState,
  (modals) => modals.isCardModalOpen
);
